...
const definitionTemplate = `import { IconDefinition } from '../types'

export const {{definitionName}}: IconDefinition = {
  name: '{{name}}',
  svgString: '{{svgString}}',
}
`
...
const outputAssetsDirname = join(packageRoot, 'components/icon/src/svg')
const outputDefinitionsDirname = join(packageRoot, 'components/icon/src/definitions')
