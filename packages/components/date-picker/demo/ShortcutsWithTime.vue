<template>
  <div class="demo-shortcut-date-picker-with-time__wrapper">
...
const _24hoursAgo = new Date(nowValue - oneDayDuration)
...
<style lang="less">
.demo-shortcut-date-picker-with-time__wrapper {
