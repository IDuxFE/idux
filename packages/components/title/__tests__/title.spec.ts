...
import { TitleInstance, TitleProps } from '../src/types'

describe('Title.vue', () => {
  let TitleMount: (options?: MountingOptions<Partial<TitleProps>>) => VueWrapper<TitleInstance>

  beforeEach(() => {
    TitleMount = options => mount<TitleInstance>(IxTitle, { ...options })
  })
