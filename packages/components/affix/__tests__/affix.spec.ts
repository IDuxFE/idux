...
import { AffixInstance, AffixOffset, AffixProps } from '../src/types'
...
describe('Affix.vue', () => {
  let AffixMount: (options?: MountingOptions<Partial<AffixProps>>) => VueWrapper<AffixInstance>

  beforeEach(() => {
    AffixMount = options => mount<AffixInstance>(IxAffix, { ...options })
