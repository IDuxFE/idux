...
| 变量名                                | default 主题                                      | 说明 |
| ------------------------------------- | ------------------------------------------------- | ---- |
| `@typography-default-color`           | `@color-black`                                          | -    |
...
| `@typography-code-border`             | `@border-width-sm solid @color-grey-d30`                 | -    |
...
| `@typography-title-1-color`           | `@color-grey-l10`                                      | -    |
...
| `@typography-title-2-color`           | `@color-grey-l10`                                      | -    |
...
| `@typography-title-3-color`           | `@color-grey-l10`                                      | -    |
...
| `@typography-title-4-color`           | `@color-grey-l10`                                      | -    |
...
| `@typography-title-5-color`           | `@color-grey-l10`                                      | -    |
