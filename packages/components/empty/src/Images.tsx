...
export const EmptyDefaultImage: FunctionalComponent = () => (
  <svg width="240" height="150" viewBox="0 0 240 150" xmlns="http://www.w3.org/2000/svg">
    <defs>
      ...
      <path id="o" d="M0 15.191L31.462 0v38.684a.376.376 0 0 1-.181.322L0 57.956V15.19z" />
      <linearGradient id="p" x1="0%" y1="45.743%" y2="53.173%">
        <stop offset="0%" stop-color="#E1E5EB" />
        <stop offset="100%" stop-color="#BEC3CC" />
      </linearGradient>
      <path id="q" d="M0 13.457l38.276 13.049L69.74 11.457 31.682 0z" />
      <linearGradient id="r" x1="13.714%" x2="13.714%" y1="13.836%" y2="113.032%">
        <stop offset="0%" stop-color="#F7F9FC" />
        <stop offset="100%" stop-color="#E1E5EB" />
      </linearGradient>
      <path id="t" d="M0 13.457l38.276 13.049L69.74 11.457 31.682 0z" />
    ...
    <g fill="none" fill-rule="evenodd">
      <g stroke-dasharray="4,10" stroke-width=".8">
        <path stroke="url(#a)" d="M.325 103.602L191.027.344" />
        <path stroke="url(#b)" d="M117.37 139.398l125.286-80.541" />
        <path stroke="url(#c)" d="M6.195 132.145L225.446 10.67" />
        <path stroke="url(#d)" d="M76.264 130.444l149.182-90.173" />
        <path stroke="url(#e)" d="M23.405 37.861l191.371 72.969-191.37-72.969z" />
        <path stroke="url(#f)" d="M32.354 14.456L237.493 89.49 32.354 14.456z" />
        <path stroke="url(#g)" d="M13.768 85.36l151.444 57.136L13.768 85.36z" />
        <path stroke="url(#h)" d="M15.144 58.513l207.204 79.164L15.144 58.513z" />
      </g>
      <path
        fill="url(#i)"
        fill-rule="nonzero"
      ...
      />
      <path fill="url(#p)" fill-rule="nonzero" d="M86.24 47.88l38.277 13.05 31.462-15.05-38.057-11.456z" />
      <g transform="translate(86.24 34.424)">
        <mask id="s" fill="#fff">
          <use xlink:href="#q" />
        </mask>
        <path fill="url(#r)" fill-rule="nonzero" d="M31.684-8.02L82.34-4.687V57.87l-50.655-1.334z" mask="url(#s)" />
      </g>
      <g transform="translate(86.24 34.424)">
        <mask id="v" fill="#fff">
          <use xlink:href="#t" />
        </mask>
        <path stroke="url(#u)" d="M31.689.124l37.726 11.358L38.269 26.38.328 13.445z" mask="url(#v)" />
      </g>
      <path
        fill="url(#w)"
        fill-rule="nonzero"
