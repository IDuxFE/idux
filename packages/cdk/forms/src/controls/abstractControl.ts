...
export abstract class AbstractControl<T = any> {
  ...
  protected _initAllStatus() {
    ;(this as any).valueRef = readonly(this._valueRef)
    this._initErrorsAndStatus()
    ;(this as any).status = readonly(this._status)
    ;(this as any).errors = readonly(this._errors)
